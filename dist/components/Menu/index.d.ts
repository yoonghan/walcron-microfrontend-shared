...
export declare function MutableMenu({ menuLink, homeLink, homeLogoLink, model, shortcutComponent, mobileStyle, desktopStyle, desktopClassName, mobileClassName, menuName, }: {
    menuLink: MenuLink;
